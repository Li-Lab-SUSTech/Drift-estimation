...
#add by shiwei 2021/04/12
scipy.io.savemat('drift_trace.mat', dict(drift_trace=drift_trace.T))
scipy.io.savemat('estimated_drift_rcc.mat', dict(estimated_drift_rcc=estimated_drift_rcc.T))
#end  shiwei 2021/04/12
